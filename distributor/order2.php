...
if(isset($_POST['place_order_add']))
{
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" class="form-inline">
                                        ...
                                        <input type='number' name='add_qty' class="form-control mr-3 ">
                                    <button class="btn-icon-o btn btn-success btn-icon-lg add_prod" type="submit" name="place_order_add">
