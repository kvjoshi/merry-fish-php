<aside id="page-aside" class=" page-aside aside-folded aside-fixed">
    <div class="sidenav darkNav">
        <a href="dashboard.php" class="app-logo d-flex flex flex-row align-items-center overflow-hidden justify-content-center">
            ...
            <span class="logo-text d-inline-flex"> <span class='font700 d-inline-block mr-1'>Merry Fish</span></span>
        </a>
        <div class="flex">
            <div class="aside-content slim-scroll">
                <ul class="metisMenu" id="metisMenu">
                    ...
                    <li> <i class="icon-Network nav-thumbnail"></i>
                        <a href="dist_list.php">
                                        <span class="nav-text">
                                            Distributors
                                        </span>
                        </a>
                    ...
                    <li> <i class="icon-Basket-Items nav-thumbnail"></i>
